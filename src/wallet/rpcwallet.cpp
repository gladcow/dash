...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "3. addlockconf         (bool, optional, default=false) Whether to add " + std::to_string(DEFAULT_INSTANTSEND_DEPTH) + " confirmations to transactions locked via InstantSend.\n"
            "\nResult:\n"
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 7)
        throw std::runtime_error(
            ...
            "5. addlockconf         (bool, optional, default=false) Whether to add " + std::to_string(DEFAULT_INSTANTSEND_DEPTH) + " confirmations to transactions locked via InstantSend.\n"
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            "4. addlockconf             (bool, optional, default=false) Whether to add " + std::to_string(DEFAULT_INSTANTSEND_DEPTH) + " confirmations to transactions locked via InstantSend.\n"
...
UniValue listreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "2. addlockconf       (bool, optional, default=false) Whether to add " + std::to_string(DEFAULT_INSTANTSEND_DEPTH) + " confirmations to transactions locked via InstantSend.\n"
            ...
            "                                                 including additional " + std::to_string(DEFAULT_INSTANTSEND_DEPTH) + " confirmations for transactions locked via InstantSend\n"
